...
const Feedback = () => (
    <section className={`${styles.paddings} relative z-10`}>
        ...
        <motion.div 
            ...
            whileInView='show'
            viewport={{once:false, amount:0.25}}
            className={`${styles.innerWidth} mx-auto flex flex-col lg:flex-row gap-6 mt-[24px]`}
        >
            <motion.div
